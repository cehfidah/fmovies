      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '1.5rem 1rem 3rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap', alignItems: 'flex-start', marginBottom: '2.5rem' }}>
          ...
          <div style={{ flex: 1, minWidth: '240px' }}>
            <div className="sk" style={{ height: '34px', width: '60%', marginBottom: '0.75rem' }} />
            {/* Badges */}
            ...
            <div className="sk" style={{ height: '14px', width: '80%', marginBottom: '0.4rem' }} />
            <div className="sk" style={{ height: '14px', width: '65%' }} />
          </div>
        </div>
